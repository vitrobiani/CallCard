...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: WasmPreviewPageWidget.routeName,
          path: WasmPreviewPageWidget.routePath,
          builder: (context, params) => WasmPreviewPageWidget(
            wasmPath: params.getParam('wasmPath', ParamType.String) ?? '',
          ),
        )
